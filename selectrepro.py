...
button1 = Button(SCREEN_WIDTH // 2 - button_width*3 // 2, SCREEN_HEIGHT // 2 - button_height - spacing,
                      button_width, button_height, "Aleatorio", font_size=25, button_color=(0, 200, 0), hover_color=(0, 255, 0))

button2 = Button(SCREEN_WIDTH // 2 + button_width // 2, SCREEN_HEIGHT // 2 - button_height - spacing,
                      button_width, button_height, "Sequencial", font_size=25, button_color=(0, 200, 0), hover_color=(0, 255, 0))
...
def selectrepro():
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            print("modo aleatorio de reprodução selecionado")
        elif button2.is_clicked(event):
            print("modo sequencial de reprodução selecionado")
